...
load("C:/Users/Tati/Dropbox/PhD/Thesis/!! WHOLE DISSERTATION !!/FINAL ANALYSIS/Coefficient of Variation/CV-2H.Rdata")
...
for (ite in 1:iter){
  N.2H.CV$CMOMd[[ite]] <- log(N.2H$CMOMd[[ite]])-log(ls.H.N[[ite]])
  N.2H.CV$CMOMi[[ite]] <- log(N.2H$CMOMi[[ite]])-log(ls.H.N[[ite]])
  N.2H.CV$CMR[[ite]]   <- log(N.2H$CMR[[ite]])-log(ls.H.N[[ite]])}
...
for (ite in 1:iter){
  B.2H.CV$CMOMd[[ite]] <- log(B.2H$CMOMd[[ite]])-log(ls.H.B[[ite]])
  B.2H.CV$CMOMi[[ite]] <- log(B.2H$CMOMi[[ite]])-log(ls.H.B[[ite]])
  B.2H.CV$CMR[[ite]]   <- log(B.2H$CMR[[ite]])-log(ls.H.B[[ite]])}
...
for (ite in 1:iter){
  phin.2H.CV$CMOMd[[ite]] <- output.2H[1,ite]-Original.H[1,ite]
  phin.2H.CV$CMOMi[[ite]] <- output.2H[9,ite]-Original.H[1,ite]
  phin.2H.CV$CMR[[ite]]   <- output.2H[17,ite]-Original.H[1,ite]}
...
for (ite in 1:iter){
  phib.2H.CV$CMOMd[[ite]] <- output.2H[3,ite]-Original.H[2,ite]
  phib.2H.CV$CMOMi[[ite]] <- output.2H[11,ite]-Original.H[2,ite]
  phib.2H.CV$CMR[[ite]]   <- output.2H[19,ite]-Original.H[2,ite]}
...
for (ite in 1:iter){
  p2.2H.CV$CMOMd[[ite]] <- output.2H[7,ite]-Original.H[4,ite]
  p2.2H.CV$CMOMi[[ite]] <- output.2H[15,ite]-Original.H[4,ite]
  p2.2H.CV$CMR[[ite]]   <- output.2H[23,ite]-Original.H[4,ite]}
...
for (ite in 1:iter){
  p1.2H.CV$CMOMd[[ite]] <- output.2H[5,ite]-Original.H[3,ite]
  p1.2H.CV$CMOMi[[ite]] <- output.2H[13,ite]-Original.H[3,ite]
  p1.2H.CV$CMR[[ite]]   <- output.2H[21,ite]-Original.H[3,ite]}
...
save(CV.2H,file="C:/Users/Tati/Dropbox/PhD/Thesis/!! WHOLE DISSERTATION !!/FINAL ANALYSIS/Coefficient of Variation/CV-2H-Table.Rdata")
