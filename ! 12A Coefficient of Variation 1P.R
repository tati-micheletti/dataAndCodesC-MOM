...
load("C:/Users/Micheletti/Dropbox/PhD/Thesis/!! WHOLE DISSERTATION !!/FINAL ANALYSIS/Coefficient of Variation/CV-1P.Rdata")
...
for (ite in 1:iter){
  N.1P.CV$CMOMd[[ite]] <- abs(log(N.1P$CMOMd[[ite]])-log(ls.N[[ite]]))
  N.1P.CV$CMOMi[[ite]] <- abs(log(N.1P$CMOMi[[ite]])-log(ls.N[[ite]]))
  N.1P.CV$CMR[[ite]]   <- abs(log(N.1P$CMR[[ite]])-log(ls.N[[ite]]))
  N.1P.CV$ZPNEc[[ite]] <- abs(log(N.ZPNEc[[ite]])-log(ls.N.ZPNE[[ite]]))
  N.1P.CV$ZPNEs[[ite]] <- abs(log(N.ZPNEs[[ite]])-log(ls.N.ZPNE[[ite]]))}
...
# ====================== B ======================= #
  ...
  for (ite in 1:iter){
    B.1P.CV$CMOMd[[ite]] <- abs(log(B.1P$CMOMd[[ite]])-log(ls.B[[ite]]))
    B.1P.CV$CMOMi[[ite]] <- abs(log(B.1P$CMOMi[[ite]])-log(ls.B[[ite]]))
    B.1P.CV$CMR[[ite]]   <- abs(log(B.1P$CMR[[ite]])-log(ls.B[[ite]]))}
  ...
  for (ite in 1:iter){
    phin.1P.CV$CMOMd[[ite]] <- abs(output.1P[1,ite]-Original.1P2P[1,ite])
    phin.1P.CV$CMOMi[[ite]] <- abs(output.1P[7,ite]-Original.1P2P[1,ite])
    phin.1P.CV$CMR[[ite]]   <- abs(output.1P[13,ite]-Original.1P2P[1,ite])}
  ...
  for (ite in 1:iter){
    phib.1P.CV$CMOMd[[ite]] <- abs(output.1P[3,ite]-Original.1P2P[2,ite])
    phib.1P.CV$CMOMi[[ite]] <- abs(output.1P[9,ite]-Original.1P2P[2,ite])
    phib.1P.CV$CMR[[ite]]   <- abs(output.1P[15,ite]-Original.1P2P[2,ite])
    phib.1P.CV$ZPNEc[[ite]] <- abs(output.ZPNEc[1,ite]-Original.1P2P[2,ite])
    phib.1P.CV$ZPNEs[[ite]]   <- abs(output.ZPNEs[1,ite]-Original.1P2P[2,ite])}
  ...
  for (ite in 1:iter){
    p2.1P.CV$CMOMd[[ite]] <- abs(output.1P[5,ite]-Original.1P2P[4,ite])
    p2.1P.CV$CMOMi[[ite]] <- abs(output.1P[11,ite]-Original.1P2P[4,ite])
    p2.1P.CV$CMR[[ite]]   <- abs(output.1P[17,ite]-Original.1P2P[4,ite])
    p2.1P.CV$ZPNEc[[ite]] <- abs(output.ZPNEc[3,ite]-Original.1P2P[4,ite])
    p2.1P.CV$ZPNEs[[ite]]   <- abs(output.ZPNEs[3,ite]-Original.1P2P[4,ite])}
...
save(CV.1P,file="C:/Users/Micheletti/Dropbox/PhD/Thesis/!! WHOLE DISSERTATION !!/FINAL ANALYSIS/Coefficient of Variation/CV-1P-TableA.Rdata")
