...
load("C:/Users/Tati/Dropbox/PhD/Thesis/!! WHOLE DISSERTATION !!/FINAL ANALYSIS/Coefficient of Variation/CV-2P.Rdata")
...
for (ite in 1:iter){
  N.2P.CV$CMOMd[[ite]] <- log(N.2P$CMOMd[[ite]])-log(ls.N[[ite]])
  N.2P.CV$CMOMi[[ite]] <- log(N.2P$CMOMi[[ite]])-log(ls.N[[ite]])
  N.2P.CV$CMR[[ite]]   <- log(N.2P$CMR[[ite]])-log(ls.N[[ite]])}
...
for (ite in 1:iter){
  B.2P.CV$CMOMd[[ite]] <- log(B.2P$CMOMd[[ite]])-log(ls.B[[ite]])
  B.2P.CV$CMOMi[[ite]] <- log(B.2P$CMOMi[[ite]])-log(ls.B[[ite]])
  B.2P.CV$CMR[[ite]]   <- log(B.2P$CMR[[ite]])-log(ls.B[[ite]])}
...
for (ite in 1:iter){
  phin.2P.CV$CMOMd[[ite]] <- output.2P[1,ite]-Original.1P2P[1,ite]
  phin.2P.CV$CMOMi[[ite]] <- output.2P[9,ite]-Original.1P2P[1,ite]
  phin.2P.CV$CMR[[ite]]   <- output.2P[17,ite]-Original.1P2P[1,ite]}
...
for (ite in 1:iter){
  phib.2P.CV$CMOMd[[ite]] <- output.2P[3,ite]-Original.1P2P[2,ite]
  phib.2P.CV$CMOMi[[ite]] <- output.2P[11,ite]-Original.1P2P[2,ite]
  phib.2P.CV$CMR[[ite]]   <- output.2P[19,ite]-Original.1P2P[2,ite]}
...
for (ite in 1:iter){
  p2.2P.CV$CMOMd[[ite]] <- output.2P[7,ite]-Original.1P2P[4,ite]
  p2.2P.CV$CMOMi[[ite]] <- output.2P[15,ite]-Original.1P2P[4,ite]
  p2.2P.CV$CMR[[ite]]   <- output.2P[23,ite]-Original.1P2P[4,ite]}
...
for (ite in 1:iter){
  p1.2P.CV$CMOMd[[ite]] <- output.2P[5,ite]-Original.1P2P[3,ite]
  p1.2P.CV$CMOMi[[ite]] <- output.2P[13,ite]-Original.1P2P[3,ite]
  p1.2P.CV$CMR[[ite]]   <- output.2P[21,ite]-Original.1P2P[3,ite]}
...
save(CV.2P,file="C:/Users/Tati/Dropbox/PhD/Thesis/!! WHOLE DISSERTATION !!/FINAL ANALYSIS/Coefficient of Variation/CV-2P-Table.Rdata")
