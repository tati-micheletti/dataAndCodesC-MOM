...
load("C:/Users/Tati/Dropbox/PhD/Thesis/!! WHOLE DISSERTATION !!/FINAL ANALYSIS/Coefficient of Variation/CV-1T.Rdata")
...
for (ite in 1:iter){
  N.1T.CV$CMOMd[[ite]] <- log(N.1T$CMOMd[[ite]])-log(ls.T.N[[ite]])
  N.1T.CV$CMOMi[[ite]] <- log(N.1T$CMOMi[[ite]])-log(ls.T.N[[ite]])
  N.1T.CV$CMR[[ite]]   <- log(N.1T$CMR[[ite]])-log(ls.T.N[[ite]])
  N.1T.CV$ZPNEc[[ite]] <- log(TN.ZPNEc[[ite]])-log(ls.N.ZPNE[[ite]])
  N.1T.CV$ZPNEs[[ite]] <- log(TN.ZPNEs[[ite]])-log(ls.N.ZPNE[[ite]])}
...
for (ite in 1:iter){
  B.1T.CV$CMOMd[[ite]] <- log(B.1T$CMOMd[[ite]])-log(ls.T.B[[ite]])
  B.1T.CV$CMOMi[[ite]] <- log(B.1T$CMOMi[[ite]])-log(ls.T.B[[ite]])
  B.1T.CV$CMR[[ite]]   <- log(B.1T$CMR[[ite]])-log(ls.T.B[[ite]])}
...
for (ite in 1:iter){
  phin.1T.CV$CMOMd[[ite]] <- output.1T[1,ite]-Original.T[1,ite]
  phin.1T.CV$CMOMi[[ite]] <- output.1T[7,ite]-Original.T[1,ite]
  phin.1T.CV$CMR[[ite]]   <- output.1T[13,ite]-Original.T[1,ite]}
...
for (ite in 1:iter){
  phib.1T.CV$CMOMd[[ite]] <- output.1T[3,ite]-Original.T[2,ite]
  phib.1T.CV$CMOMi[[ite]] <- output.1T[9,ite]-Original.T[2,ite]
  phib.1T.CV$CMR[[ite]]   <- output.1T[15,ite]-Original.T[2,ite]
  phib.1T.CV$ZPNEc[[ite]] <- output.ZPNEc[1,ite]-Original.T[2,ite]
  phib.1T.CV$ZPNEs[[ite]]   <- output.ZPNEs[1,ite]-Original.T[2,ite]}
...
for (ite in 1:iter){
  p2.1T.CV$CMOMd[[ite]] <- output.1T[5,ite]-Original.T[4,ite]
  p2.1T.CV$CMOMi[[ite]] <- output.1T[11,ite]-Original.T[4,ite]
  p2.1T.CV$CMR[[ite]]   <- output.1T[17,ite]-Original.T[4,ite]
  p2.1T.CV$ZPNEc[[ite]] <- output.ZPNEc[3,ite]-Original.T[4,ite]
  p2.1T.CV$ZPNEs[[ite]]   <- output.ZPNEs[3,ite]-Original.T[4,ite]}
...
save(CV.1T,file="C:/Users/Tati/Dropbox/PhD/Thesis/!! WHOLE DISSERTATION !!/FINAL ANALYSIS/Coefficient of Variation/CV-1T-Table.Rdata")
