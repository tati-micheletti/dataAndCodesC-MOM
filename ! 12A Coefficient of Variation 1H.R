...
load("C:/Users/Micheletti/Dropbox/PhD/Thesis/!! WHOLE DISSERTATION !!/FINAL ANALYSIS/Coefficient of Variation/CV-1H.Rdata")
...
for (ite in 1:iter){
  N.1H.CV$CMOMd[[ite]] <- abs(log(N.1H$CMOMd[[ite]])-log(ls.H.N[[ite]]))
  N.1H.CV$CMOMi[[ite]] <- abs(log(N.1H$CMOMi[[ite]])-log(ls.H.N[[ite]]))
  N.1H.CV$CMR[[ite]]   <- abs(log(N.1H$CMR[[ite]])-log(ls.H.N[[ite]]))
  N.1H.CV$ZPNEc[[ite]] <- abs(log(HN.ZPNEc[[ite]])-log(ls.N.ZPNE[[ite]]))
  N.1H.CV$ZPNEs[[ite]] <- abs(log(HN.ZPNEs[[ite]])-log(ls.N.ZPNE[[ite]]))}
...
for (ite in 1:iter){
  B.1H.CV$CMOMd[[ite]] <- abs(log(B.1H$CMOMd[[ite]])-log(ls.H.B[[ite]]))
  B.1H.CV$CMOMi[[ite]] <- abs(log(B.1H$CMOMi[[ite]])-log(ls.H.B[[ite]]))
  B.1H.CV$CMR[[ite]]   <- abs(log(B.1H$CMR[[ite]])-log(ls.H.B[[ite]]))}
...
for (ite in 1:iter){
  phin.1H.CV$CMOMd[[ite]] <- abs(output.1H[1,ite]-Original.H[1,ite])
  phin.1H.CV$CMOMi[[ite]] <- abs(output.1H[7,ite]-Original.H[1,ite])
  phin.1H.CV$CMR[[ite]]   <- abs(output.1H[13,ite]-Original.H[1,ite])}
...
for (ite in 1:iter){
  phib.1H.CV$CMOMd[[ite]] <- abs(output.1H[3,ite]-Original.H[2,ite])
  phib.1H.CV$CMOMi[[ite]] <- abs(output.1H[9,ite]-Original.H[2,ite])
  phib.1H.CV$CMR[[ite]]   <- abs(output.1H[15,ite]-Original.H[2,ite])
  phib.1H.CV$ZPNEc[[ite]] <- abs(output.ZPNEc[1,ite]-Original.H[2,ite])
  phib.1H.CV$ZPNEs[[ite]]   <- abs(output.ZPNEs[1,ite]-Original.H[2,ite])}
...
for (ite in 1:iter){
  p2.1H.CV$CMOMd[[ite]] <- abs(output.1H[5,ite]-Original.H[4,ite])
  p2.1H.CV$CMOMi[[ite]] <- abs(output.1H[11,ite]-Original.H[4,ite])
  p2.1H.CV$CMR[[ite]]   <- abs(output.1H[17,ite]-Original.H[4,ite])
  p2.1H.CV$ZPNEc[[ite]] <- abs(output.ZPNEc[3,ite]-Original.H[4,ite])
  p2.1H.CV$ZPNEs[[ite]] <- abs(output.ZPNEs[3,ite]-Original.H[4,ite])}
...
save(CV.1H,file="C:/Users/Micheletti/Dropbox/PhD/Thesis/!! WHOLE DISSERTATION !!/FINAL ANALYSIS/Coefficient of Variation/CV-1H-TableA.Rdata")
