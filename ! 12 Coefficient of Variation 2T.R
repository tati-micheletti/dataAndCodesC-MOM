...
load("C:/Users/Tati/Dropbox/PhD/Thesis/!! WHOLE DISSERTATION !!/FINAL ANALYSIS/Coefficient of Variation/CV-2T.Rdata")
...
for (ite in 1:iter){
  N.2T.CV$CMOMd[[ite]] <- log(N.2T$CMOMd[[ite]])-log(ls.T.N[[ite]])
  N.2T.CV$CMOMi[[ite]] <- log(N.2T$CMOMi[[ite]])-log(ls.T.N[[ite]])
  N.2T.CV$CMR[[ite]]   <- log(N.2T$CMR[[ite]])-log(ls.T.N[[ite]])}
...
for (ite in 1:iter){
  B.2T.CV$CMOMd[[ite]] <- log(B.2T$CMOMd[[ite]])-log(ls.T.B[[ite]])
  B.2T.CV$CMOMi[[ite]] <- log(B.2T$CMOMi[[ite]])-log(ls.T.B[[ite]])
  B.2T.CV$CMR[[ite]]   <- log(B.2T$CMR[[ite]])-log(ls.T.B[[ite]])}
...
for (ite in 1:iter){
  phin.2T.CV$CMOMd[[ite]] <- output.2T[1,ite]-Original.T[1,ite]
  phin.2T.CV$CMOMi[[ite]] <- output.2T[9,ite]-Original.T[1,ite]
  phin.2T.CV$CMR[[ite]]   <- output.2T[17,ite]-Original.T[1,ite]}
...
for (ite in 1:iter){
  phib.2T.CV$CMOMd[[ite]] <- output.2T[3,ite]-Original.T[2,ite]
  phib.2T.CV$CMOMi[[ite]] <- output.2T[11,ite]-Original.T[2,ite]
  phib.2T.CV$CMR[[ite]]   <- output.2T[19,ite]-Original.T[2,ite]}
...
for (ite in 1:iter){
  p2.2T.CV$CMOMd[[ite]] <- output.2T[7,ite]-Original.T[4,ite]
  p2.2T.CV$CMOMi[[ite]] <- output.2T[15,ite]-Original.T[4,ite]
  p2.2T.CV$CMR[[ite]]   <- output.2T[23,ite]-Original.T[4,ite]}
...
for (ite in 1:iter){
  p1.2T.CV$CMOMd[[ite]] <- output.2T[5,ite]-Original.T[3,ite]
  p1.2T.CV$CMOMi[[ite]] <- output.2T[13,ite]-Original.T[3,ite]
  p1.2T.CV$CMR[[ite]]   <- output.2T[21,ite]-Original.T[3,ite]}
...
save(CV.2T,file="C:/Users/Tati/Dropbox/PhD/Thesis/!! WHOLE DISSERTATION !!/FINAL ANALYSIS/Coefficient of Variation/CV-2T-Table.Rdata")
